      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="m1">Главные ветви</a></li>
            <li><a href="#m2">Вспомогательные ветви</a></li>
            <li><a href="#m3">Ветви функциональностей</a></li>
            <li><a href="#m4">Ветви релизов</a></li>
            <li><a href="#m5">Ветви исправлений</a></li>
          </ul>
        </div><!-- /.nav-collapse -->
      </div><!-- /.container -->
    </div><!-- /.navbar -->
